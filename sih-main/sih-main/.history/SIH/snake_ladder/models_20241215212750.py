...
class GameRoom(models.Model):
    ...
    def update_points(self, player_id, points_to_add):
        """Update points for a player in this game and sync with overall points"""
        if not self.points:
            self.points = {}
        ...
        # Set total points to match game room points
        overall_points.total_points = self.points.get(str(player_id), 0)
        overall_points.save()
